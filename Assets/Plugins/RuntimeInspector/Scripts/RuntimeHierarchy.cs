...
namespace RuntimeInspectorNamespace
{
	public class RuntimeHierarchy : SkinnedWindow, IListViewAdapter
	{
		...
		[SerializeField]
		private PointerEventListener closeBtn;
...
#pragma warning restore 0649
		...
		protected override void Awake()
		{
			...
			closeBtn.PointerClick += (eventData) => ClickClose();
		}

		private void ClickClose()
		{
			GameObject.Destroy(closeBtn.gameObject);
			GameObject.Destroy(gameObject);

			if(ConnectedInspector != null)
				GameObject.Destroy(ConnectedInspector.gameObject);
		}
